...
const View = () => {
  ...
  if (!item) return <div className='flex items-center justify-center h-screen'><div className='text-center'><p className='text-2xl font-bold text-black'>Item not found</p></div></div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
            ...
            <div className='flex flex-col gap-8'>
              ...
              <div className='flex flex-wrap gap-3'>
                ...
                <Link className='px-6 py-3 bg-white border-2 border-black text-black rounded font-semibold text-sm hover:bg-black hover:text-white transition-all duration-300 text-center'>
                  View in room
                </Link>
                <Link className='px-6 py-3 bg-white border-2 border-black text-black rounded font-semibold text-sm hover:bg-black hover:text-white transition-all duration-300 text-center'>
                  Share
              ...
              <div className='bg-white border-l-4 border-red-500 pl-6 pr-4 py-6 rounded shadow-sm'>
                <h3 className='text-lg font-bold text-black mb-4 uppercase tracking-wide'>About the Art</h3>
            ...
            <div className='flex flex-col justify-between gap-8'>
              ...
              <div className='space-y-8'>
                ...
                <div className='border-b-2 border-black pb-6'>
                  <p className='text-xs font-bold text-black uppercase tracking-widest mb-2'>Artist</p>
                  <p className='text-2xl font-bold text-black'>{item.inventor}</p>
                </div>

                {/* Size */}
                <div className='border-b-2 border-black pb-6'>
                  <p className='text-xs font-bold text-black uppercase tracking-widest mb-2'>Dimensions</p>
                  <p className='text-xl font-mono text-black'>{item.size}</p>
                </div>

                {/* Price */}
                <div className='border-b-2 border-black pb-6'>
                  <p className='text-xs font-bold text-black uppercase tracking-widest mb-2'>Price</p>
                  <p className='text-4xl font-bold text-red-500'>{item.price}</p>
                </div>
              </div>
